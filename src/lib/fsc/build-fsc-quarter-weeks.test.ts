...
test('current quarter uses monthly projection after the fourth direct weekly horizon', () => {
  const input = createInput([]);
  input.forecastRun = {
    id: 'forecast-run-extended-weekly',
    forecastModelVersion: null,
    mapePct: null,
    maeKrwPerL: null,
    metadata: null,
    ...
    points: [
      {
        ...
        horizonKind: 'weekly',
        horizonIndex: 5,
        targetDate: new Date('2026-07-02T00:00:00.000Z'),
        pointKrwPerL: new Prisma.Decimal('1400'),
      },
      {
        id: 'monthly-horizon-1',
        horizonKind: 'monthly',
        horizonIndex: 1,
        targetDate: new Date('2026-07-31T00:00:00.000Z'),
        pointKrwPerL: new Prisma.Decimal('1600'),
      },
    ],
  };
