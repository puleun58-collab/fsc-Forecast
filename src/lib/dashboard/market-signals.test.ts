  ...
  const signals = buildPublicMarketSignals([
    {
      indicatorCode: 'dubai',
      rows: [
        { observedAt: new Date('2026-07-14T00:00:00.000Z'), value: 95 },
        { observedAt: new Date('2026-06-14T00:00:00.000Z'), value: 100 },
      ],
    },
    {
      indicatorCode: 'brent',
      rows: [
        { observedAt: new Date('2026-07-14T00:00:00.000Z'), value: 80 },
        { observedAt: new Date('2026-07-13T00:00:00.000Z'), value: 79 },
      ],
    },
    {
      indicatorCode: 'wti',
      rows: [
        { observedAt: new Date('2026-07-14T00:00:00.000Z'), value: 78 },
        { observedAt: new Date('2026-07-13T00:00:00.000Z'), value: 77 },
      ],
    },
    {
      indicatorCode: 'usd-krw',
      rows: [
        { observedAt: new Date('2026-07-10T00:00:00.000Z'), value: 1380 },
        { observedAt: new Date('2026-07-09T00:00:00.000Z'), value: 1390 },
      ],
    },
  ]);
